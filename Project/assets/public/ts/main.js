    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 6:
                ...
                document.getElementById("button1").innerHTML = character.name;
                document.getElementById("button2").innerHTML = characterB.name;
                document.getElementById("button3").innerHTML = characterC.name;
                ...
                keuze = parseInt("1")//readline.question("Kies een antwoord (getal 1 tot 3): "));
                switch (keuze) {
                    case 1:
                        if (extra == character.name) {
